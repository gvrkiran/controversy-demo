    ...
    function o(b, i, h, c, d, g, a, f, k) {
        function l(a) {
            ...
            var h = d(a.displayX + 10),
                ...
                i = d(b.measureText(a.id).width + 6),
                m = d(f + 4);
            d(f / 2 + 2);
            b.fillRect(h, g, i, m);
            b.shadowOffsetX = 0;
            ...
            for (var b = a.nodes.length, c = 0; c++ < j.p.labelsSpeed && j.currentLabelIndex < b;) if (j.isOnScreen(a.nodes[j.currentLabelIndex])) {
                ...
                if (d.displaySize >= j.p.labelThreshold) {
                    ...
                    var i = Math.round,
                        ...
                        k = i(f.measureText(d.id).width + 6),
                        v = i(g + 4);
                    i(g / 2 + 2);
        ...
        this.drawActiveNode = function (a) {
            ...
            sigma.tools.drawRoundRect(b, Math.round(a.displayX - d / 2 - 2), Math.round(a.displayY - d / 2 - 2), Math.round(b.measureText(a.id).width + 1.5 * a.displaySize + d / 2 + 4), Math.round(d + 4), Math.round(d / 2 + 2), "left");
            b.closePath();
            b.fill();
            b.shadowOffsetX = 0;
            b.shadowOffsetY = 0;
